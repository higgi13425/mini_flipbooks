...
`r chunk_reveal("filter1", 
    break_type = "auto", 
    title = "Example 1: Filter Rows Between Dates")`
...
`r chunk_reveal("filter2", 
    break_type = "auto", 
    title = "Example 2: Find Bone Marrow Transplants in 2008-2018 in 40-70 yo")`
...
`r chunk_reveal("filter3", 
    break_type = "auto", 
    title = "Example 3: Find Acute GVHD Cases in last 24 Months")`
...
`r chunk_reveal("filter4", 
    break_type = "auto", 
    title = "Example 4: Find BMTs on (Fake) Weekends")`
